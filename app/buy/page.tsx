        ...
        <main className="min-h-screen pb-20 bg-gray-50">
            ...
            >
                <div className="container mx-auto max-w-6xl">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Shop Phones & Accessories 🛒</h1>
                    <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto">
                        Browse our collection of premium phones and accessories. Buy from our store or discover products at trusted partner shops.
                    </p>
                </div>
            </section>
