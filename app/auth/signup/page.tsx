        ...
        <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="p-8 text-center">
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Join MobileCafe.lk</h1>
                    <p className="text-gray-600 mb-8">Choose how you want to join us</p>
                        ...
                        <Link href="/auth/signup/customer" className="block group">
                            <div className="border-2 border-gray-100 rounded-xl p-4 hover:border-[#A73860] hover:bg-gray-50 transition-all flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-sm text-gray-500">I want to buy, sell, or fix phones</p>
                                </div>
                            </div>
                        </Link>

                        <Link href="/auth/signup/shop" className="block group">
                            <div className="border-2 border-gray-100 rounded-xl p-4 hover:border-[#A73860] hover:bg-gray-50 transition-all flex items-center gap-4">
                                <div className="bg-gray-100 p-3 rounded-full group-hover:bg-[#A73860] group-hover:text-white transition-colors">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-sm text-gray-500">I want to grow my business</p>
                                </div>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100">
                        <p className="text-gray-600 text-sm">
                            ...
                            <Link href="/auth/signin" className="font-bold text-[#A73860] hover:underline">
                                Sign In
                            </Link>
                        </p>
                    </div>
